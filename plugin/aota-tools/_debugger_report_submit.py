...
def _do_submit(args: dict) -> str:
    ...
    card = apply_common_card(meta, "debugger", card, "DIAGNOSIS.md")
    # Write DIAGNOSIS_CARD.json
    card_path = assert_artifact_target(task_dir, "DIAGNOSIS_CARD.json", allowed={"DIAGNOSIS_CARD.json", "DIAGNOSIS.md"})
    md_path = assert_artifact_target(task_dir, "DIAGNOSIS.md", allowed={"DIAGNOSIS_CARD.json", "DIAGNOSIS.md"})
