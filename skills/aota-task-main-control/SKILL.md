...
---
> **W1 Deployment Projection — Generated Derivative (Not Canonical)**
>
> ```text
> AOTA_SKILL_CANONICAL_SOURCE=aota_forge
> AOTA_HERMES_TOOLS_SKILL_AUTHORITY=no
> CANONICAL_SOURCE=aota_forge/skills/aota-task-main-control/SKILL.md
...
> `aota_forge/skills/aota-task-main-control/SKILL.md` for Hermes native Skill
