...
> CANONICAL_SOURCE=aota_forge/skills/aota-pcf-project-steward/SKILL.md
...
> Canonical semantic authority is `aota_forge/skills/aota-pcf-project-steward/SKILL.md`.
