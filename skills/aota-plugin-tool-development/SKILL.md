...
> CANONICAL_SOURCE=aota_forge/skills/aota-plugin-tool-development/SKILL.md
...
> Canonical semantic authority is `aota_forge/skills/aota-plugin-tool-development/SKILL.md`.
