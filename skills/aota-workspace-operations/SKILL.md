...
---
> **W2 Deployment Projection — Generated Derivative (Not Canonical)**
>
> ```text
> AOTA_SKILL_CANONICAL_SOURCE=aota_forge
> AOTA_HERMES_TOOLS_SKILL_AUTHORITY=no
> CANONICAL_SOURCE=aota_forge/skills/aota-workspace-operations/SKILL.md
> THIS_FILE_IS_PROJECTION=yes
> THIS_FILE_IS_GENERATED_DERIVATIVE=yes
> DEPLOYMENT_PROJECTION_IS_AUTHORITY=no
> SKILL_IS_AUTHORITY=no
> ```
>
> This file is a **deterministic deployment projection** of the AF canonical Skill
> `aota_forge/skills/aota-workspace-operations/SKILL.md` for Hermes native Skill
> discovery/loading compatibility. It is **not** canonical; parity is
> deterministically verifiable via `aota_forge/scripts/skill_descriptor_drift_guard.py`.
